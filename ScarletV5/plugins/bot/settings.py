...
from ScarletV5.utils.decorators.admins import ActualAdminCB
from ScarletV5.utils.decorators.language import language, languageCB
from ScarletV5.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ScarletV5.utils.inline.start import private_panel
import config
...
@app.on_callback_query(filters.regex("Axiom_Back") & ~BANNED_USERS)
@languageCB
...
# ---------------------------------------------------
# 🚀 NEW: the_maanav_help_callback (To display CLONE_HELP)
# ---------------------------------------------------

@app.on_callback_query(filters.regex("the_maanav_help") & ~BANNED_USERS)
@languageCB
async def the_maanav_help_callback(client, CallbackQuery, _):
    try:
        await CallbackQuery.answer()
    except:
        pass
    
    # New keyboard to navigate back to the video/repo page
    ...
    # Edit the message to show the CLONE_HELP text
    await CallbackQuery.edit_message_caption(
        caption=helpers.CLONE_HELP,
        reply_markup=keyboard,
        parse_mode=ParseMode.HTML # Assuming CLONE_HELP uses HTML formatting (<b>, <u>, <code>)
    )


# ---------------------------------------------------
# Rest of the Callbacks (Unchanged)
# ---------------------------------------------------
