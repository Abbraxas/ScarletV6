...
# check_bot_premium yahan se hata diya gaya hai kyunki ab zarurat nahi
...
async def set_channel(client: Client, message: Message, _):
    ...
    # Sirf Owner check karega, Premium check hata diya
...
async def bot_info(client: Client, message: Message, _):
    ...
    # Premium status logic hata diya gaya hai
    
     # Format and send the response (Bot Status line hata di gayi hai)
