...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="-2", callback_data="FERRARIUDTI M", style=ButtonStyle.PRIMARY),
            InlineKeyboardButton(
                text=f"ᴄᴜʀʀᴇɴᴛ : {current}",
                callback_data="ANSWERVOMODE",
                style=ButtonStyle.SUCCESS,
            ),
            InlineKeyboardButton(text="+2", callback_data="FERRARIUDTI A", style=ButtonStyle.PRIMARY),
        ],
        [
            InlineKeyboardButton(
                text=_["BACK_BUTTON"],
