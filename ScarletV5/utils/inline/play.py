...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="ηєᴡʙσᴛ", url=f"https://t.me/newbot/cuqebot", style=random_style()),
        ]
    ]
    return buttons
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"AxiomPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"AxiomPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_2(_, videoid, chat_id):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["S_B_3"],
                url=f"httpst.me/{app.username}?startgroup=true",
            ),
        ],
        [
            InlineKeyboardButton(
